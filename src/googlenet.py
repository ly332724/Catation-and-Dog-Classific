...
def train():
    ...
    for i, data in enumerate(train_loader):
        ...
        # 交叉熵代价函数
        loss = entropy_loss(out, labels).to(device)  # 损失函数也需要发到GPU
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
...
# 保存训练好的模型
torch.save(model.state_dict(), '/home/ly/code/opencv/cat_dog/mode/googlenet.pth')
print("~结束训练")
